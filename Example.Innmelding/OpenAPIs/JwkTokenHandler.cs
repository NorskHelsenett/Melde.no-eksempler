...
namespace OpenAPIs
{
    ...
    public class JwkTokenHandler : DelegatingHandler
    {
        ...
        public JwkTokenHandler(string stsUrl, string clientId, Dictionary<string, object> jwtPrivateKey, ClientType clientType)
        {
            _stsUrl = stsUrl;
            _clientId = clientId;
            ...
            CancellationToken cancellationToken)
        {
            ...
            var accessToken = await HelseIdTokenHelper.GetAccessToken(_stsUrl, _clientId, _jwtPrivateKey, _clientType, cancellationToken);
